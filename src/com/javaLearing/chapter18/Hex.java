...
public class Hex {
    ...
    public static void main(String[] args) throws Exception {
        if(args.length == 0)
            ...
            //为了打开及读入二进制文件，我们用到了另一个工具 Files.readAllBytes()，这已经在 Files章节 介绍过了。
            // 这里的 readAllBytes() 方法将整个文件以 byte 数组的形式返回。
            System.out.println(format(
                    Files.readAllBytes(Paths.get(
                            "/Users/shenheng/Code/out/production/ADT算法/com/javaLearing/chapter18/Turtle.class"))));
        else
            System.out.println(format(
